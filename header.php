...
<body>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('input[value="Subscription🔁"]').click(function(e) {
                e.preventDefault();
                $.ajax({
                    url: 'subscription.php',
                    type: 'GET',
                    success: function(response) {
                        // Create and show popup with subscription content
                        $('<div class="subscription-popup">'+response+'</div>')
                            .appendTo('body')
                            .modal();
                    }
                });
      ...
      <div class="container">
        ...
        <div class="w3ls_logo_products_left1">
          <ul class="phone_email">
            <li><i class="fa fa-phone" aria-hidden="true"></i> <a href="tel:+918885114269">(+91) 8885114269</a></li>
            <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:sai@spirit.org.in"> <a href="mailto:sai@spirit.org.in">sai@spirit.org.in</a></li>
          </ul>
        </div>
        <div class="clearfix"></div>
      </div>
